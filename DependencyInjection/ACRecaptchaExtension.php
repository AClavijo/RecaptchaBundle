 ...
 */
class ACRecaptchaExtension extends Extension
{
    /**
     * {@inheritDoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        foreach ($config as $key => $value) {
            $container->setParameter('ac_recaptcha.'.$key, $value);
        }
    ...
    protected function registerWidget(ContainerBuilder $container)
    {
        ...
        if (in_array('twig', $templatingEngines)) {
            $formRessource = 'ACRecaptchaBundle:Form:ac_recaptcha_widget.html.twig';
